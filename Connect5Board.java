...
public class Connect5Board extends Board {
			...
			while(board[r][localCol] == i || board[r][localCol] == 4  ) {
				...
				count++;
					...
					return true;
                                ...
                                if(count >= 1 && (localCol - 5) >= 0){
                                    checkWin(r, (localCol - 5), i);
                                }
			...
			while(board[localRow][localCol] == i || board[localRow][localCol] == 4) {
				...
				if(count == 5) {
					...
					return true;
                                 ...
                                 if(count >= 1 && (localCol - 5) >= 0 && (localRow - 5) >= 0){ //middle case
                                    checkWin((localRow - 5), (localCol - 5), i);
			...
			while(board[localRow][localCol] == i || board[localRow][localCol] == 4) {
				...
				if(count == 5) {
					...
					return true;
                                ...
                                if(count >= 1 && (localCol + 5) < cols && (localRow - 5) >= 0){ //middle case
                                    checkWin((localRow - 5), (localCol + 5), i);
			...
			while(board[localRow][localCol] == i || board[localRow][localCol] == 4) {
				...
				if(count == 5) {
					...
					return true;
                                ...
                                if(count >= 1 && (localCol - 5) >= 0 && (localRow + 5) < rows){ //middle case
                                    checkWin((localRow + 5), (localCol - 5), i);
			...
			while(board[localRow][localCol] == i || board[localRow][localCol] == 4) {
				...
				if(count == 5) {
					...
					return true;
                                ...
                                if(count >= 1 && (localCol + 5) < cols && (localRow + 5) < rows){ //middle case
                                    checkWin((localRow + 5), (localCol + 5), i);
    ...
    public void setPiece(int col, int i) {
        ...
        if(rowcount != -1) {
            ...
            if(checkWin(rowcount,fixedcol,i))
                 System.exit(0);
        }
        else
